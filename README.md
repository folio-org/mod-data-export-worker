...
| QUANTITY_PER_PARTITION                            | 5000                          | Number of records per one partition in bulk edit job                                                                                                                                                  |
| MERGE_CSV_JSON_MRC_POOL_SIZE                      | 3                             | Number of threads to merge csv, json and mrc part files in bulk edit job                                                                                                                              |
| NUM_PARTITIONS                                    | 8                             | Number of partitions in bulk edit job                                                                                                                                                                 |
| MINUTES_FOR_MERGE                                 | 10                            | Number of minutes to wait until all csv, json and mrc part files are merged in bulk edit job                                                                                                          |
