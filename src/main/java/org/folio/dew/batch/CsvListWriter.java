...
public class CsvListWriter<T, R extends S3CompatibleStorage> extends AbstractStorageStreamWriter<List<T>, R> {
  ...
  public CsvListWriter(String tempOutputFilePath, String columnHeaders, String[] extractedFieldNames, AbstractStorageStreamWriter.FieldProcessor fieldProcessor, R storage) {
