...
@Component
@StepScope
public class AuthUpdateHeadingsItemReader extends AbstractItemCountingItemStreamItemReader<AuthorityDataStatDto> {
  ...
  protected AuthUpdateHeadingsItemReader(EntitiesLinksStatsClient entitiesLinksStatsClient,
