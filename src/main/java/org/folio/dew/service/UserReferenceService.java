...
public class UserReferenceService {
  ...
  private final ModUsersModuleService modUsersModuleService;
  ...
  public CustomField getCustomFieldByRefId(String refId) {
    return customFieldsClient.getCustomFieldsByQuery(modUsersModuleService.getModUsersModuleId(), String.format("refId==\"%s\"", refId))
