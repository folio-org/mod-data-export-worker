...
public class Constants {
  ...
  public static final Map<EntityType, String> ENTITY_TYPE_TO_ELECTRONIC_ACCESS_DELIMITER = Map.of(HOLDINGS_RECORD, HOLDINGS_DELIMITER, ITEM, ITEM_DELIMITER, INSTANCE, ITEM_DELIMITER);
  public static final Map<EntityType, String> ENTITY_TYPE_TO_ELECTRONIC_ACCESS_DATA_DELIMITER = Map.of(HOLDINGS_RECORD, ELECTRONIC_RELATIONSHIP_NAME_ID_DELIMITER, ITEM, ARRAY_DELIMITER, INSTANCE, ARRAY_DELIMITER);
