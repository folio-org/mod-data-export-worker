...
class MultipleFeeFinesMatchingCriteriaTest extends BaseBatchTest {
  ...
  private static final String GET_ITEMS_REQUEST =
    "/inventory/items?query=id%3D%3D%28%28100d10bf-2f06-4aa0-be15-0b95b2d9f9e4%20or%20100d10bf-2f06-4aa0-be15-0b95b2d9f9e3%20or%209dcf8868-ed0b-40cf-bb93-e73b44b565f0%29%29&limit=50";

  private static final String EXPECTED_CHARGE_OUTPUT =
    "src/test/resources/output/bursar_multiple_matching_fees.dat";
  ...
  void testMultipleFeeFinesMatching() throws Exception {
    ...
    final JobParameters jobParameters = BursarFeesFinesTestUtils.prepareMultipleFeeFinesMatchingJobParameters(
      ...
      postRequestedFor(
        ...
        .withRequestBody(
          matchingJsonPath(
            "$.accountIds",
            equalTo(
              "[ \"807becbc-c3e6-4871-bf38-d140597e41cb\", \"3d68adf3-abae-4792-a865-aa4a077ba909\" ]"
            )
          )
        )
    );
