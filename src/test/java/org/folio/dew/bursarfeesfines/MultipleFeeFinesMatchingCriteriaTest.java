...
class MultipleFeeFinesMatchingCriteriaTest extends BaseBatchTest {

  @Autowired
  private Job bursarExportJob;

  private static final String GET_USERS_REQUEST = "/users?query=id%3D%3D%28%287793317e-35fc-4a09-ae12-b1ed66636ffc%20or%20bec20636-fb68-41fd-84ea-2cf910673599%20or%202205005b-ca51-4a04-87fd-938eefa8f6de%29%29&limit=50";

  private static final String GET_ITEMS_REQUEST = "/inventory/items?query=id%3D%3D%28%28100d10bf-2f06-4aa0-be15-0b95b2d9f9e4%20or%20100d10bf-2f06-4aa0-be15-0b95b2d9f9e3%20or%209dcf8868-ed0b-40cf-bb93-e73b44b565f0%29%29&limit=50";

  private static final String EXPECTED_CHARGE_OUTPUT = "src/test/resources/output/bursar_multiple_matching_fees.dat";

  @Test
  @DisplayName("Run bursar export with multiple fees/fines matching criteria")
  void testMultipleFeeFinesMatching() throws Exception {
        ...
        .withBody("""
            {
              "accounts": [
                ...
                },
                {
                  ...
                  "feeFineId": "29904908-b935-4214-8b79-2d474212be3e",
                  "ownerId": "782c9784-cba0-480a-b8c0-1ffba088c9a5",
    ...
    wireMockServer.verify(getRequestedFor(urlPathMatching(BursarFeesFinesTestUtils.TRANSFERS_ENDPOINT_PATH)));

    wireMockServer.verify(getRequestedFor(urlEqualTo(BursarFeesFinesTestUtils.SERVICE_POINTS_GET_REQUEST)));

    wireMockServer.verify(1, postRequestedFor(urlEqualTo(BursarFeesFinesTestUtils.TRANSFER_ACCOUNTS_ENDPOINT)));

    wireMockServer.verify(postRequestedFor(urlEqualTo(BursarFeesFinesTestUtils.TRANSFER_ACCOUNTS_ENDPOINT))
      .withRequestBody(matchingJsonPath("$.amount", equalTo("550.0")))
      .withRequestBody(matchingJsonPath("$.servicePointId", equalTo("afdb59ae-1185-4cd7-94dd-39a87fe01c51")))
