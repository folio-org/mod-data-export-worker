...
class NoFeeFineMatchingCriteriaTest extends BaseBatchTest {
  ...
  @Test
  @DisplayName(
    "Run bursar export job with no fee/fine matching the filter criteria"
  )
  void testNoFeeFineMatching() throws Exception {
    ...
    final JobParameters jobParameters = BursarFeesFinesTestUtils.prepareNoFeeFineMatchingJobParameters(
