...
class NoFeeFineMatchingCriteriaTest extends BaseBatchTest {
  ...
  void testNoFeeFineMatching() throws Exception {
    ...
    final JobParameters jobParameters = BursarFeesFinesTestUtils.prepareNoFeeFineMatchingJobParameters(springApplicationName,
        objectMapper);
    ...
    assertThat(jobExecution.getAllFailureExceptions()
      .get(0)
      .getMessage(), containsString("No accounts matched the criteria"));
