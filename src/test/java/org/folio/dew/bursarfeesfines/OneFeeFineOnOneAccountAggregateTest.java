...
class OneFeeFineOnOneAccountAggregateTest extends BaseBatchTest {
  ...
  private static final String GET_ITEMS_REQUEST = "/inventory/items?query=id%3D%3D%28%28100d10bf-2f06-4aa0-be15-0b95b2d9f9e3%29%29&limit=50";

  private static final String EXPECTED_CHARGE_OUTPUT = "src/test/resources/output/bursar_one_fee_on_one_account_aggregate.dat";
  ...
  void testOneFeesFines() throws Exception {
    ...
    final JobParameters jobParameters = BursarFeesFinesTestUtils.prepareOneFeeFineOnOneAccountAggregateTest(springApplicationName,
        objectMapper);
    ...
    wireMockServer.verify(postRequestedFor(urlEqualTo(BursarFeesFinesTestUtils.TRANSFER_ACCOUNTS_ENDPOINT))
      ...
      .withRequestBody(matchingJsonPath("$.accountIds", equalTo("[ \"807becbc-c3e6-4871-bf38-d140597e41cb\" ]"))));
