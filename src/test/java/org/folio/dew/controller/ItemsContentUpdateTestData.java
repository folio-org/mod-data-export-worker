...
import static org.folio.dew.domain.dto.ItemContentUpdate.OptionEnum.TEMPORARY_LOAN_TYPE;
...
public enum ItemsContentUpdateTestData {
  ...
  REPLACE_WITH_PERMANENT_LOAN_TYPE(PERMANENT_LOAN_TYPE, REPLACE_WITH, "Reading room",
    "src/test/resources/output/expected_items_with_updated_permanent_loan_type.json",
    "src/test/resources/output/expected_items_with_updated_permanent_loan_type.csv",
    "src/test/resources/output/expected_items_with_updated_permanent_loan_type.csv"),
  REPLACE_WITH_TEMPORARY_LOAN_TYPE(TEMPORARY_LOAN_TYPE, REPLACE_WITH, "Reading room",
    "src/test/resources/output/expected_items_with_updated_temporary_loan_type.json",
    "src/test/resources/output/expected_items_with_updated_temporary_loan_type.csv",
    "src/test/resources/output/expected_items_with_updated_temporary_loan_type.csv"),
  REPLACE_WITH_NULL_PERMANENT_LOAN_TYPE(PERMANENT_LOAN_TYPE, REPLACE_WITH, null,
    "src/test/resources/output/expected_items_with_deleted_permanent_loan_type.json",
    "src/test/resources/output/expected_items_with_deleted_permanent_loan_type.csv",
    "src/test/resources/output/expected_preview_items_with_deleted_permanent_loan_type.csv"),
  REPLACE_WITH_NULL_TEMPORARY_LOAN_TYPE(TEMPORARY_LOAN_TYPE, REPLACE_WITH, null,
    "src/test/resources/output/expected_items_with_deleted_temporary_loan_type.json",
    "src/test/resources/output/expected_items_with_deleted_temporary_loan_type.csv",
    "src/test/resources/output/expected_preview_items_with_deleted_temporary_loan_type.csv"),
  ...
  CLEAR_FIELD_STATUS(STATUS, CLEAR_FIELD, null,
    "src/test/resources/output/expected_items_with_non_updated_status.json",
    null, null),
  CLEAR_FIELD_PERMANENT_LOAN_TYPE(PERMANENT_LOAN_TYPE, CLEAR_FIELD, null,
    "src/test/resources/output/expected_items_with_deleted_permanent_loan_type.json",
    "src/test/resources/output/expected_items_with_deleted_permanent_loan_type.csv",
    "src/test/resources/output/expected_preview_items_with_deleted_permanent_loan_type.csv"),
  CLEAR_FIELD_TEMPORARY_LOAN_TYPE(TEMPORARY_LOAN_TYPE, CLEAR_FIELD, null,
    "src/test/resources/output/expected_items_with_deleted_temporary_loan_type.json",
    "src/test/resources/output/expected_items_with_deleted_temporary_loan_type.csv",
    "src/test/resources/output/expected_preview_items_with_deleted_temporary_loan_type.csv");
